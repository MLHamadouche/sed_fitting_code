...
fig, ax = plt.subplots()
c = my_masses # color of points
im = ax.scatter(bagpipes_ages, massi_ages,c=c,s=5, cmap=plt.cm.BuPu_r)
im2 = ax.plot(bagpipes_ages, bagpipes_ages, color="black")
# Add a colorbar
...
plt.savefig('age_mass_cbar.png')
plt.close()

######### mass v mass with age cbar ####################################
fig, ax = plt.subplots()
c = massi_ages*10**9  # color of points
im = ax.scatter(bagpipes_mass, my_masses,c=c,s=5, cmap=plt.cm.BuPu_r)
im2 = ax.plot(bagpipes_mass, bagpipes_mass, color="black")
...
fig, ax = plt.subplots()
c = massi_ages*10**9  # color of points
im = ax.scatter(ross_mass, my_masses,c=c,s=5, cmap=plt.cm.BuPu_r)
im2 = ax.plot(ross_mass, ross_mass, color="black")
