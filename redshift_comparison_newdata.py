...
pht_plus = 0.85*mortlock2 - 0.15
pht_neg  = 1.15*mortlock2+ 0.15
...
plt.scatter(mortlock2, massi_z, color='darkseagreen', s = 12, marker='o', alpha = 0.9, edgecolors='black',  linewidth=0.5)
plt.scatter(mortlock2[dzm>0.15], massi_z[dzm>0.15], s=8, color ='lightcoral', marker='o',alpha=0.9, edgecolors= "black", linewidth=0.5)
plt.scatter(mortlock2[dzm<-0.15], massi_z[dzm<-0.15], s=8, color ='lightcoral', marker='o', alpha=0.9, edgecolors= "black", linewidth=0.5)
#plt.scatter(ross_z, outliers, color = 'k', s=4)
plt.plot(mortlock2, mortlock2, color="k", linewidth=0.7, label = '1:1 line')
plt.plot(mortlock2, pht_neg, ':', color = "k", linewidth=0.3)
plt.plot(mortlock2, pht_plus, ':', color = "k", linewidth=0.3)
#plt.xlim(0.,6.8)
#plt.ylim(0.,6.8)
plt.xlabel(r'Mortlock2')
...
plt.savefig('ECDFS_mortlock_validation_redshifts.png')
plt.close()
